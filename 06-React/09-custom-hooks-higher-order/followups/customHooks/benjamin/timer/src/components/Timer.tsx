        ...
        <motion.div
         ...
         transition={{ duration: 0.8 }}>
          <div className=" flex flex-col w-96 h-96 bg-slate-950 justify-around items-center rounded-xl">
            <div style={{backgroundColor: bgColor }} className=" w-80 h-20 text-6xl text-gray-950 font-mono font-extrabold rounded-lg transition-all ease-in-out">
              {formattedTime}
            </div>
            <motion.div
             initial={{ y: 12, opacity: 0 }}
