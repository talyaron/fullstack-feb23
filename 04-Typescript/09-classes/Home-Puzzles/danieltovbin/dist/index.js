...
var Celebs = /** @class */ (function () {
    function Celebs(fullName, genre, tikTokAccount, instagramAccount, numberOfFollowers) {
    ...
    Celebs.prototype.setNumberOfFollowers = function (newNumberOfFollowers) {
        var getNumberOfFollowers = newNumberOfFollowers - this.numberOfFollowers;
        try {
            if (this.numberOfFollowers < newNumberOfFollowers)
                return ("The number of followers increased by " + getNumberOfFollowers);
            if (this.numberOfFollowers > newNumberOfFollowers)
                return ("The number of followers decreased by " + getNumberOfFollowers);
            if (this.numberOfFollowers == newNumberOfFollowers)
                return ('The number of followers is the same');
        }
        catch (error) {
            console.error(error);
            return;
...
var michelleObama = new Celebs('Michelle Obama', 'education', 'https://www.tiktok.com/@1michelleobamaofficial', 'https://www.instagram.com/michelleobama/', 6000000);
var brianTracy = new Celebs('Brian Tracy', 'speaker and author', 'https://www.tiktok.com/@briantracyofficial', 'https://www.instagram.com/thebriantracy/', 2000000);
var yuvalNoahHarari = new Celebs('Yuval Noah Harari', 'historian', 'https://www.tiktok.com/@yuval2030harari', 'https://www.instagram.com/yuval_noah_harari/', 4000000);
var jimKwik = new Celebs('Jim Kwik', 'coach', 'https://www.tiktok.com/search?q=jimkwik&t=1685501599494', 'https://www.instagram.com/jimkwik/', 3000000);
