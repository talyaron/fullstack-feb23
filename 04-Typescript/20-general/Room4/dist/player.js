...
var audioElements = [
    new AudioElement("Her Ghost in The Fog", "Cradle Of Filth", new Audio("./dist/Cradle of Filth - Her Ghost in The Fog (192 kbps).mp3"), 'https://www.metalcallout.com/sites/default/files/img/cradledarklycover2.jpg', 1),
    new AudioElement("Final Countdown", "Europe", new Audio("./dist/Europe - The Final Countdown.mp3"), 'https://upload.wikimedia.org/wikipedia/en/2/22/The_Final_Countdown_single.png', 2)
];
