...
if (songsArray.length === 0) {
    var song1 = new Song(1, 'Can not feel my face', 'Red Band', '../dist/media/redBand&ninet', '../dist/media/220px-Red_-_band_press_photo.jpg');
    ...
    var song5 = new Song(5, 'try', 'Justin Bieber', '../dist/media/JustinBieber-Peaches.mp3', '../dist/media/justin-bieber-gettyimages-1202421980.jpg');
