...
console.log(userImgArray[0].user.name); //creat view to show the user profile.
...
showUserImg(document.querySelector('#profile'), userImgArray); //creat a butten to add new image.
