//     if (menu_button.getAttribute("active")){
// const html = `<div class="popup" id="popup">
// <ul id="popupList">
//   <li><a href="../home-page/homepage.html">עמוד הבית</a></li>
//   <li> <a href="../home/Income.html">הוצאות</a></li>
//   <li> <a href="#Sport">הכנסות</a></li>
//   <li> <a href="#Reel">הרווח שלי</a></li>
//   <li>  <a href="../home-page/homepage.html#contact">יצירת קשר</a></li>
//   <li> <a href="#Travel">יצירת קשר</a></li>
// </ul>
// </div>`
//       // popup.classList.toggle("show-popup") ;
//       popup.classList.toggle.innerHTML = html;
//     }
//   }
function toggleMenu() {
