...
var UserCategories = /** @class */ (function () {
    function UserCategories(categoryName, categoryId) {
        this.categoryName = categoryName;
        this.categoryId = categoryId;
    }
...
function handleExpenceSubmit(ev) {
    ...
    try {
        ...
        var categoryId_2 = ev.target.categories.value;
        ...
        var categoryName = (_a = Categorys.find(function (category) { return "id-" + category.categoryId === categoryId_2; })) === null || _a === void 0 ? void 0 : _a.categoryName;
        expences.push(new Expence(expenceDescription, categoryName, categoryId_2, expenceAmount));
...
function deleteExpense(ev) {
    ...
    var indexUserCategories = userCategories.findIndex(function (category) { return category.categoryId === expenseId; });
