var userGender = String(prompt("enter your gender, male/female/ other."));
var userHeight = Number(prompt('enter your height.'));
avarageHeight(userGender, userHeight);
function avarageHeight(gender, height) {
    try {
        if ((gender !== "male") && (gender !== "female") && (gender !== "other"))
            throw new Error('wrong gender entry');
        if (isNaN(height))
            throw new Error('the entry is not a number');
        var femaleAvarage = 166;
        var maleAvarage = 177;
        if (gender == "male") {
            if (height > 177) {
                ...
                document.write("your height is " + (maleAvarage - height) + " below avarage");
        }
        if (gender == "female") {
            if (height > 166) {
                ...
                document.write("your height is " + (femaleAvarage - height) + " below avarage");
        }
        if (gender == "other") {
