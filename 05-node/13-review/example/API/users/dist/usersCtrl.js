...
function register(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, hash, userDB, cookie, secret, JWTCookie, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (!secret)
                        throw new Error("on FILE usersCtrl on function register: no secret");
                ...
                case 3:
                    error_1 = _b.sent();
                    res.send({ register: false, error: error_1.messgae });
                    return [3 /*break*/, 4];
