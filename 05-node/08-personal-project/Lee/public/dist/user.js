    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("/API/users/get-user-data?email=" + email)];
                case 1:
                    response = _a.sent();
...
function handleGetUsers() {
    var email = _getEmailFromQuery(); // Get the user's email from the URL query
    if (!email) {
