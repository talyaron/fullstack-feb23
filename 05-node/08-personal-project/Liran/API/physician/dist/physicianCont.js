...
function addPhysician(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, firstName, lastName, age, phoneNum, email, licenseNumber, isAdmin, physician, physicianDB, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, firstName = _a.firstName, lastName = _a.lastName, age = _a.age, phoneNum = _a.phoneNum, email = _a.email, licenseNumber = _a.licenseNumber, isAdmin = _a.isAdmin;
                    if (!firstName || !lastName || !age || !phoneNum || !email || !licenseNumber)
                        throw new Error("Please complete all fields");
                    physician = new physicianModel_1.PhysicianModel({ firstName: firstName, lastName: lastName, age: age, phoneNum: phoneNum, email: email, licenseNumber: licenseNumber, isAdmin: isAdmin });
...
function updatePhysician(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, id, firstName, lastName, age, phoneNum, email, password, licenseNumber, physician, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, id = _a.id, firstName = _a.firstName, lastName = _a.lastName, age = _a.age, phoneNum = _a.phoneNum, email = _a.email, password = _a.password, licenseNumber = _a.licenseNumber;
                    if (!id)
