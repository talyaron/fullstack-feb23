...
function hundlePhysicianUpdateSubmit(event) {
    return __awaiter(this, void 0, void 0, function () {
        var id, firstName, lastName, age, phoneNum, email_1, licenseNumber, password, isAdmin, response, data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    ...
                    return [4 /*yield*/, fetch("/API/physician/update-physician", {
                            ...
                            body: JSON.stringify({ id: id, firstName: firstName, lastName: lastName, age: age, phoneNum: phoneNum, email: email_1, licenseNumber: licenseNumber, password: password, isAdmin: isAdmin })
                        })];
                case 1:
                    response = _a.sent();
...
function hundleMedicineSubmit(event) {
    return __awaiter(this, void 0, void 0, function () {
        var name, dosagePerDay, maxDuration, response, data, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
...
function hundlePatientUpdateSubmit(event) {
    return __awaiter(this, void 0, void 0, function () {
        var id, firstName, lastName, age, phoneNum, weight, height, smoking, address, physicianId, response, data, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
...
function hundleMedicineUpdateSubmit(event) {
    return __awaiter(this, void 0, void 0, function () {
        var id, name, dosagePerDay, maxDuration, response, data, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
...
function hundlePatientSubmit(event) {
    return __awaiter(this, void 0, void 0, function () {
        var firstName, lastName, patientId, age, phoneNum, weight, height, smoking, address, physicianId, response, data, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
...
function hundlePhysicianSubmit(event) {
    return __awaiter(this, void 0, void 0, function () {
        var firstName, lastName, age, phoneNum, email_2, licenseNumber, password, isAdmin, response, data, error_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    ...
                    return [4 /*yield*/, fetch("/API/physician/add-physician", {
                            ...
                            body: JSON.stringify({ firstName: firstName, lastName: lastName, age: age, phoneNum: phoneNum, email: email_2, licenseNumber: licenseNumber, password: password, isAdmin: isAdmin })
                        })];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
...
function renderMedicineList(html) {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, medicinesList, tempHtml_2, error_11;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 2:
                    ...
                    tempHtml_2 = "<h2>Medicine List</h2>\n        <table>\n        <tr>\n        <th>Name</th>\n        <th>Dosage Per Day</th>\n        <th>Max Days</th>\n        </tr>";
...
function renderPhysicianList(html) {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, physiciansList, tempHtml_5, error_14;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 2:
                    ...
                    tempHtml_5 = "<h2>Physician List</h2>\n        <table>\n        <tr>\n        <th>First Name</th>\n        <th>Last Name</th>\n        <th>Age</th>\n        <th>Phone Number</th>\n        <th>Email</th>\n        <th>License Number</th>\n        <th>Admin</th>\n        </tr>";
                    physiciansList.forEach(function (physician) {
...
function renderAddPatient(html) {
    return __awaiter(this, void 0, void 0, function () {
        var tempHtml_7, physiciansList, error_17;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
...
function renderUpdatePhysician(html) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var tempHtml_8, physiciansList, error_18;
...
function renderUpdateMedicine(html) {
    return __awaiter(this, void 0, void 0, function () {
        var tempHtml_10, medicinesList, error_20;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
...
function renderVisitsList(html) {
    return __awaiter(this, void 0, void 0, function () {
        var visitsList, tempHtml_11, promise, error_21;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function loadMedicineDetails() {
    return __awaiter(this, void 0, void 0, function () {
        var id_1, response, data, medicine, idInput, nameInput, dosagePerDayInput, maxDurationInput, error_23;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 2:
                    data = _a.sent();
                    medicine = data.medicines.find(function (medicine) { return medicine._id === id_1; });
...
function getPhysiciansList() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, physiciansList, error_24;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
...
function getPatientsList() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, patientsList, error_25;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
...
function loadDetails() {
    return __awaiter(this, void 0, void 0, function () {
        var id_2, response, data, physician, idInput, firstNameInput, lastNameInput, ageInput, phoneNumInput, emailInput, licenseNumberInput, passwordInput, isAdminCheckbox, error_26;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 2:
                    data = _a.sent();
                    physician = data.physicians.find(function (physician) { return physician._id === id_2; });
                    idInput = document.querySelector("#id");
...
function loadPatientDetails() {
    return __awaiter(this, void 0, void 0, function () {
        var id_3, response, data, patient, idInput, firstNameInput, lastNameInput, ageInput, phoneNumInput, weightInput, heightInput, smokingCheckbox, addressInput, physicianIdInput, error_27;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 2:
                    data = _a.sent();
                    patient = data.patients.find(function (patient) { return patient._id === id_3; });
                    idInput = document.querySelector("#id");
                    firstNameInput = document.querySelector("#firstName");
                    lastNameInput = document.querySelector("#lastName");
                    ageInput = document.querySelector("#age");
