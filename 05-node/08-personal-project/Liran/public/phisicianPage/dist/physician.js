...
function renderUpdatePatientP(patients, html) {
    return __awaiter(this, void 0, void 0, function () {
        var tempHtml_1, responseP, dataP, physicianID_1, response, data, patientsList, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
...
function updatePatientP() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, responseP, dataP, physicianID_2, patientList, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
...
function viewVisits() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, responseP, dataP, physicianID_3, visits, error_8;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                ...
                case 4:
                    ...
                    visits = data.visits.filter(function (visit) { return visit.physician === physicianID_3; });
                    console.log(visits);
                    renderVisits(visits);
                    return [3 /*break*/, 6];
                case 5:
