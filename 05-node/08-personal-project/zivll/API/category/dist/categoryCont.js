...
exports.getCategories = exports.addCategoey = void 0;
var categoryModel_1 = require("./categoryModel");
exports.addCategoey = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, categoryName, userName, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, categoryName = _a.categoryName, userName = _a.userName;
