...
function handleAddFriend(event) {
    return __awaiter(this, void 0, void 0, function () {
        var firstName, lastName, age, imgUrl, errorMessageElement, errorMessage, friend, response, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    friend = { firstName: firstName, lastName: lastName, age: age, imgUrl: imgUrl };
...
function handleUpdateFriend(ev) {
    return __awaiter(this, void 0, void 0, function () {
        var age, id, response, result, friends, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("/API/update-friend", {
                            ...
                            body: JSON.stringify({ id: id, age: age })
                        })];
                case 2:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
