...
function handleAddFriend(ev) {
    return __awaiter(this, void 0, void 0, function () {
        var firstname, lastname, age, friend, response, result;
...
function getFriends() {
    return __awaiter(this, void 0, void 0, function () {
        var response, results, friends;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('/API/get-friends')];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
...
function renderProducts(friends, HTMLElement) {
    try {
        if (!HTMLElement)
        ...
        var productsHTML = friends.map(function (friend) { return renderProductHTML(friend); }).join("");
