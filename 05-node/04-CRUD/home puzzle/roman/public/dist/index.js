...
function handleAddFriend(event) {
    return __awaiter(this, void 0, void 0, function () {
        var name, email, phone, instagram, friend, response, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    phone = event.target.phone.valueAsNumber;
                    instagram = event.target.instagram.value;
                    if (!name || !email || !phone || !instagram) {
                        throw new Error("Please complete all fields");
                    }
                    friend = { name: name, email: email, phone: phone, instagram: instagram };
...
function handleUpdateFriend(ev) {
    return __awaiter(this, void 0, void 0, function () {
        var name, id, phone, email, instagram, response, result, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    ...
                    id = ev.target.id;
                    phone = ev.target.phone.valueAsNumber;
                    email = ev.target.email.value;
                    instagram = ev.target.instagram.value;
                    return [4 /*yield*/, fetch("/API/update-friend", {
                            method: "PATCH",
                            headers: {
                                "Content-Type": "application/json"
                            },
                            body: JSON.stringify({ id: id, name: name, phone: phone, email: email, instagram: instagram })
                        })];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
...
function handleDeleteFriend(id) {
    return __awaiter(this, void 0, void 0, function () {
        var response, result, friends, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
