...
function renderTask(task, root) {
  if (root === void 0) {
    root = document.querySelector(".tasksListDiv");
  }
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , fetch("/API/delete-task", deleteInit)];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , fetch("/API/patch-task", patchInit)];
...
function renderPage() {
  var userMail = window.location.href.replace("http://localhost:3001/index.html?email=", "");
