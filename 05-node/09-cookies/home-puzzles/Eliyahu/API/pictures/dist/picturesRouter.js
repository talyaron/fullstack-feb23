...
router
    ...
    .get('/get-next-picture', picturesConts_1.getNextPicture)
    .post('/add-picture', userMiddleware_1.isPremium, picturesConts_1.addPicture)["delete"]('/delete-picture', picturesConts_1.deletePicture)
