    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          if (!(!userEmail || userEmail === null || userEmail === undefined)) return [3
          /*break*/
          , 3];
          return [4
          /*yield*/
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          if (!imgUrl || !price || !title || !description || !userEmail) throw new Error("Some fields are empty");
          ...
          return [4
          /*yield*/
          , fetch("/API/products/create-product", postInit)];
        ...
        case 3:
          ...
          if (!ok || !newProduct) throw new Error("product not create on DB server error");
          renderMyStore();
          return [3
          /*break*/
          , 5];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , fetch("/API/users/get-user-from-cookie")];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , fetch("/API/products/get-products-by-owner-email")];
        ...
        case 3:
          ...
          html = usersProducts.map(function (product) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          if (!newTitle || !newPrice || !newDescription) throw new Error("some filed are  empty");
          patchInit = {
            method: "PATCH",
            headers: {
              "Content-Type": "application/json"
          ...
          return [4
          /*yield*/
          , fetch("/API/products/update-product-info", patchInit)];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , fetch("/API/products/delete-product", deleteInit)];
