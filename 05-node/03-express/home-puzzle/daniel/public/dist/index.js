    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetch('/user')]; //wait for the response from server
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetch('/age')]; //wait for the response from server
            case 1:
                response = _a.sent() //wait for the response from server
                ;
                console.timeEnd('fetching age');
                console.log(response);
                return [4 /*yield*/, response.json()]; //wait for data to be parsed
            case 2:
                data = _a.sent() //wait for data to be parsed
                ;
                console.log(data);
