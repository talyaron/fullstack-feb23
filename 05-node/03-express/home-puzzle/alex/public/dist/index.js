...
//async await
var getHeader = function () { return __awaiter(_this, void 0, void 0, function () {
    var response, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.time('fetching title');
                return [4 /*yield*/, fetch('/title')]; //wait for the response from server
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetch('/info')]; //wait for the response from server
            case 1:
                response = _a.sent() //wait for the response from server
                ;
